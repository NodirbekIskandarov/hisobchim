...
def _parse_system_prompt(today: date) -> str:
    ...
    return (
        ...
        "\"1 200 000\" => 1200000.\n"
        "- Turini kontekstdan aniqla. \"oldim\", \"sotib oldim\", \"to'ladim\", "
        "\"berdim\" odatda chiqim. \"oylik tushdi\", \"ishladim\", \"kirdi\" — kirim.\n"
        "- \"Aliga 500 ming qarz berdim\" => qarz_berdim, shaxs=\"Ali\". "
        "\"Akamdan 1 mln qarz oldim\" => qarz_oldim, shaxs=\"akam\".\n"
        "- \"kecha\", \"ertalab\", \"1-avgustda\" kabi vaqt ko'rsatkichlarini sanaga aylantir. "
        "Vaqt aytilmasa bugungi sana.\n"
        "- Kategoriyani faqat ro'yxatdagilardan tanla. Ishonching komil bo'lmasa "
        "\"boshqa chiqim\" yoki \"boshqa kirim\" qo'y.\n"
